...
public class ValidatorErrorCodes {
    ...
    public static final String ORDER_CANNOT_BE_CANCELLED = "Orders can only be canceled within the first 12 hours after placement. This order is no longer eligible for cancellation.";
